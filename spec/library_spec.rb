...
describe "Library object" do
	...
	before :all do 
		...
		lib_obj = [
			...
			Book.new("JavaScript Patters", "Stoyan Stefanov", :development),
			Book.new("Resnponsive Web Design", "Ethan Marcotte", :design)
		]
	...
	it "returns all books in a given category" do
		@lib.get_books_in_category(:development).length.should == 5
	end
